...
var useCardInit = function useCardInit(props) {
  var canvasRef = props.canvasRef,
    width = props.width,
    height = props.height,
    coverColor = props.coverColor,
    coverImg = props.coverImg;
  var isScratching = useRef(false);
  var _useState = useState(false),
    _useState2 = _slicedToArray(_useState, 2),
    initDone = _useState2[0],
    setInitDone = _useState2[1]; // 网络图片加载有延迟，初始化完成在渲染底层dom
  ...
  var initCanvas = /*#__PURE__*/function () {
    ...
    return function initCanvas() {
      return _ref.apply(this, arguments);
    };
  }();
  var terminateCanvas = function terminateCanvas() {
    var canvas = canvasRef.current;
    if (!canvas) return;
    canvas.removeEventListener('mousedown', scratchController.bind(null, true));
    canvas.removeEventListener('touchstart', scratchController.bind(null, true));
  ...
  var handleScratch = function handleScratch(e) {
  ...
  var scratchController = function scratchController(scratching) {
